<template>
    <div id="directional-arrow-component">
        <template v-if="angleToDailyCity">
            <svg :style="{ transform: `rotate(${-angleToDailyCity}deg)`, transformOrigin: 'center' }" width="28" height="18"
